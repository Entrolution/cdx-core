//! Example: Create a CDX document from scratch.
//!
...
fn main() -> Result<()> {
    ...
    let document = Document::builder()
        .title("My First CDX Document")
        .creator("Example Author")
        .add_heading(1, "Introduction")
        .add_paragraph("This is an example CDX document created with cdx-core.")
        .add_heading(2, "Features")
        .add_paragraph("CDX documents provide:")
        ...
        .add_paragraph("The CDX format is designed for the future of digital documents.")
        .build()?;
